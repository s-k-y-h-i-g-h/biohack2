...
pub fn seed_catalog() -> Vec<CatalogItem> {
    vec![
        ...
        CatalogItem { name: "Boron".to_string(), category: "mineral".to_string(), dosage_range: Some(DosageRange { min: 1.0, max: 3.0, unit: "mg".to_string() }) },
        ...
        CatalogItem { name: "Phosphatidylserine".to_string(), category: "nootropic".to_string(), dosage_range: Some(DosageRange { min: 100.0, max: 300.0, unit: "mg".to_string() }) },
        CatalogItem { name: "L-Tyrosine".to_string(), category: "nootropic".to_string(), dosage_range: Some(DosageRange { min: 500.0, max: 1000.0, unit: "mg".to_string() }) },
        ...
        CatalogItem { name: "Rhodiola Rosea".to_string(), category: "adaptogen".to_string(), dosage_range: Some(DosageRange { min: 200.0, max: 400.0, unit: "mg".to_string() }) },
        ...
        CatalogItem { name: "Berberine".to_string(), category: "metabolic".to_string(), dosage_range: Some(DosageRange { min: 500.0, max: 1500.0, unit: "mg".to_string() }) },
        CatalogItem { name: "Collagen Peptides".to_string(), category: "gut".to_string(), dosage_range: Some(DosageRange { min: 10.0, max: 20.0, unit: "g".to_string() }) },
        CatalogItem { name: "Probiotic".to_string(), category: "gut".to_string(), dosage_range: Some(DosageRange { min: 1.0, max: 10.0, unit: "CFU billion".to_string() }) },
        CatalogItem { name: "Quercetin".to_string(), category: "anti-inflammatory".to_string(), dosage_range: Some(DosageRange { min: 500.0, max: 1000.0, unit: "mg".to_string() }) },
        CatalogItem { name: "Apigenin".to_string(), category: "anti-inflammatory".to_string(), dosage_range: Some(DosageRange { min: 25.0, max: 50.0, unit: "mg".to_string() }) },
        CatalogItem { name: "Cordyceps".to_string(), category: "adaptogen".to_string(), dosage_range: Some(DosageRange { min: 500.0, max: 1000.0, unit: "mg".to_string() }) },
        CatalogItem { name: "Reishi Mushroom".to_string(), category: "adaptogen".to_string(), dosage_range: Some(DosageRange { min: 500.0, max: 1000.0, unit: "mg".to_string() }) },
        CatalogItem { name: "Umcka (Pelargonium)".to_string(), category: "adaptogen".to_string(), dosage_range: Some(DosageRange { min: 20.0, max: 30.0, unit: "mg".to_string() }) },
    ]
}
